...
namespace ControlCenter.Shared.Extensions;
...
public static class CollectionExtension
{
    ...
    {
        return collection.AddIndexItem(expressionName, valueName, null, null, index);
    }
    ...
    {
        return collection.AddIndexItem(expressionName, valueName, expressionId, valueId, 0);
    }

    public static IList<T> AddLastItem<T>(this IList<T> collection, Expression<Func<T, string>> expressionName, string valueName)
    {
        return collection.AddLastItem(expressionName, valueName, null, null);
    }

    public static IList<T> AddLastItem<T>(this IList<T> collection, Expression<Func<T, string>> expressionName,
        string valueName, Expression<Func<T, int?>> expressionId, int? valueId)
    {
        return collection.AddIndexItem(expressionName, valueName, expressionId, valueId, collection.Count);
    }
}
