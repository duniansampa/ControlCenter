using ControlCenter.Shared.Caching.Provider;
using ControlCenter.Shared.Extensions;
using System.Linq.Expressions;

namespace ControlCenter.Shared.Caching.Service;

public sealed class CacheService : ICacheService, IAsyncCacheService
{
