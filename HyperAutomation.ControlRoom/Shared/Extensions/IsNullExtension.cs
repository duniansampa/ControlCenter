...
namespace HyperAutomation.ControlRoom.Shared.Extensions
{
    public static class IsNullExtension
    {
        ...
        public static string IsNotNullConcatRight(
            this string str, 
        ...
        public static string IsNotNullConcatLeft(
            this string str, 
            params string[] concat)
        {
            if (str.IsNullOrEmpty())
