...
namespace HyperAutomation.ControlRoom.Shared.Extensions
{
    public static class CollectionExtension
    {
        ...
        public static bool IsGratherThanZero<T>(
            this IEnumerable<T> collection)
        {
            return collection.IsGratherThan<T>(0);
        }

        public static bool IsGratherThan<T>(
            this IEnumerable<T> collection,
            int count)
        {
            if (collection == null)
        ...
        public static TModel SingleOrNew<TModel>(
            this List<TModel> collection)
        {
        ...
        public static TModel SingleOrNew<TModel>(
            this IEnumerable<TModel> collection,
            Func<TModel, bool> predicate)
        {
            var obj = collection.SingleOrDefault(predicate);
            if (obj == null)
        ...
        public static TModel FirstOrNew<TModel>(
            this List<TModel> collection)
        {
        ...
        public static List<TModel> AddOnEmpty<TModel>(
            this List<TModel> collection)
        {
        ...
        public static DataSet ToDataSet<TModel>(
            this IList<TModel> collection)
        {
            var dts = new DataSet();
        ...
        public static void AddRangeIfNotContains<T>(
            this IList<T> collection,
        ...
        public static void AddIfTrueAndNotContains<T>(
            this IList<T> collection,
            T value,
            bool flag)
        {
        ...
        private static string GetProperty<T>(
        ...
        public static IList<T> AddIndexItem<T>(
            this IList<T> collection,
            Expression<Func<T, string>> expressionName,
            string valueName,
            int index)
        {
        ...
        public static IList<T> AddIndexItem<T>(
            ...
            Expression<Func<T, string>> expressionName,
            string valueName,
            Expression<Func<T, int?>> expressionId,
            int? valueId,
            int index)
        {
        ...
        public static IList<T> AddFirstItem<T>(
            this IList<T> collection,
            Expression<Func<T, string>> expressionName,
        ...
        public static IList<T> AddLastItem<T>(
            this IList<T> collection,
            Expression<Func<T, string>> expressionName,
            string valueName)
        {
        ...
        public static IList<T> AddLastItem<T>(
            this IList<T> collection, Expression<Func<T, string>> expressionName,
            string valueName,
            Expression<Func<T, int?>> expressionId,
            int? valueId)
        {
